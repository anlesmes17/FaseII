...
/*
SELECT Month, Count(Distinct ID_CLIENTE) NumClientes FROM MobileUsefulFields_BOM 
GROUP BY Month*/
...
,MobileChurners AS (
Select DISTINCT e.ID_CLIENTE AS Account_EOM, b.ID_ABONADO AS ID_BOM, b.ID_CLIENTE As Account_BOM
