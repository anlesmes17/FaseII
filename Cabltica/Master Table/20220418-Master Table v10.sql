...
,AverageMRC_User AS(
  SELECT DISTINCT FECHA_EXTRACCION AS Month, act_acct_cd, VO_FI_TOT_MRC_AMT AS mrcVO, BB_FI_TOT_MRC_AMT AS mrcBB, TV_FI_TOT_MRC_AMT AS mrcTV,(VO_FI_TOT_MRC_AMT + BB_FI_TOT_MRC_AMT + TV_FI_TOT_MRC_AMT) as avgmrc, TOT_BILL_AMT AS Bill
  FROM `gcp-bia-tmps-vtr-dev-01.gcp_temp_cr_dev_01.2022-04-18_CRM_Sample_Ene_Mar_2022_Revenue`
  GROUP BY Month, act_acct_cd, mrcVO, mrcBB, mrcTV, Bill
)
