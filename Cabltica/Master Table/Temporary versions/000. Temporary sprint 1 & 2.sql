...
CASE
WHEN ((FinalChurnFlag="Full Churner" OR FinalChurnFlag="Fixed Churner" OR FinalChurnFlag="Fixed churner - Customer Gap" AND (Mobile_ActiveEOM=0 OR Mobile_ActiveEOM IS NULL)) AND FixedChurnType="Voluntario" AND MobileChurnFlag IS NULL) Then "Voluntary"
WHEN ((FinalChurnFlag="Full Churner" OR FinalChurnFlag="Fixed Churner" OR FinalChurnFlag="Fixed churner - Customer Gap" AND (Mobile_ActiveEOM=0 OR Mobile_ActiveEOM IS NULL)) AND FixedChurnType="Involuntario" AND MobileChurnFlag IS NULL) Then "Involuntary"
