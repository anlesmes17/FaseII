...
,SolicitudesMasterTable AS(
  SELECT a.*,b.contrato AS SolicitudDesconexiones FROM HardDxMasterTable a LEFT JOIN SolicitudDesconexiones b
...
count(distinct SoftDxAccount) AS SoftDxAccount,count(distinct HardDxAccount) AS HardDxAccount,
